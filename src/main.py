...
def main():
    ...
    st.write('## Here to help you win (cheat) at Wordle!')
    ...
    st.write('NOTE: For the example word of "hello", if there is a single "l" in the answer word, The Wordler will expect BOTH "l"s to have "1"s, but Wordle will only give the first "l" a "1". For now, you should enter the feedback for both "l"s as "1"s.')
    ...
    with col3:
        ...
        if guesses and not bad_input:
            ...
            st.write(f'Total Number of Words Remaining: {len(filtered_data)}')
